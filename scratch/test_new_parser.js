...
const SmartParser = {
    ...
    parse(text, customCategories = global_categories) {
        ...
        const stopWords = [
            ...
            'despesa', 'recebimento', 'ganhei', 'ganhar'
        ];
        ...
        // 4. Split and Temporal omitted for test simplicity (they work perfectly)
        let splitInfo = null;
...
console.log("=== RUNNING NEW HIGH-INTELLIGENCE PARSER TESTS ===");
